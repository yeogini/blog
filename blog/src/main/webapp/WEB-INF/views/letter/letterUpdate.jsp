...
<title>Insert title here</title>
  ...
  <link rel="stylesheet" href="resources/assets/bootstrap-material-design-font/css/material.css">
  <link rel="stylesheet" href="resources/assets/web/assets/mobirise-icons/mobirise-icons.css">
  <link rel="stylesheet" href="resources/assets/et-line-font-plugin/style.css">
...
<section class="mbr-section mbr-section-hero mbr-section-full header2 mbr-parallax-background mbr-after-navbar" id="header2-1" style="background-image: url(resources/assets/images/t.jpg);">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
							...
							<form action="letterUpdate.do" method="post">
								...
								<div class="nav-link link dropdown-toggle mbr-editable-menu-item">
